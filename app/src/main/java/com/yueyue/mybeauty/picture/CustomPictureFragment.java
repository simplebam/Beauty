...
import com.yueyue.mybeauty.net.DataFetcher;
                ...
                .subscribe(new Subscriber<List<Image>>() {
                    ...
                    public void onError(Throwable e) {
                        ...
                        if (page > 1 && images.size() > 3 && inAPost) {
                            ...
                            if (error > 2) {
                                SnackUtil.showSnackLong(rootView, R.string.net_error);
                            } else {
                                SnackUtil.showSnack(rootView, R.string.load_fail);
                            }
                        }
                        e.printStackTrace();
                    }
...
//    }
    ...
    private void startPost(Image image) {
        ...
        //纠正对Fragment Transaction BackStack的误解 - CSDN博客
        //      http://blog.csdn.net/guxiao1201/article/details/40476267
