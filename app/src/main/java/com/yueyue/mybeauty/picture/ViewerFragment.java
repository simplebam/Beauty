...
import com.yueyue.mybeauty.helper.BlurBuilder;
import com.yueyue.mybeauty.lib.TouchImageView;
...
import com.yueyue.mybeauty.utils.BitmapUtil;
    ...
    private void load() {
        ...
        Imager.loadDefer(this, image, new SimpleTarget<Bitmap>() {
            ...
            public void onLoadFailed(Exception e, Drawable errorDrawable) {
                ...
                SnackUtil.showSnackLong(imageView, R.string.picture_load_fail, R.string.retry,
                        v -> load());
            }
        ...
        Subscription subscription = permissions.request(Manifest.permission.WRITE_EXTERNAL_STORAGE)
                ...
                .subscribe(file -> {
                    if (file != null && file.exists()) {
                        ...
                        SnackUtil.showSnack(rootView, R.string.set_wallpaper_failed);
                    }
                ...
                .subscribe(granted -> {
                    if (granted) {
                        if (BitmapUtil.writeToFile(bitmap).exists()) {
                            ...
                            SnackUtil.showSnack(rootView, R.string.save_img_success,
                                    R.string.dont_hint, v -> SpUtil.save(DONT_HINT, true));

                        } else {
                            SnackUtil.showSnack(rootView, R.string.save_img_failed);
                        }
                    }
                }, throwable -> throwable.printStackTrace());
        tasks.add(subscription);
